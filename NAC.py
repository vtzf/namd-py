...
#-*- encoding:utf-8 -*-
import Args
if Args.interface == 'ABACUS':
    import NACfunc_ABACUS as NACfunc
elif Args.interface == 'VASP':
    import NACfunc_VASP as NACfunc
elif Args.interface == 'OpenMX':
    import NACfunc_OpenMX as NACfunc
import MPIfunc
